...
import storm_control.sc_hardware.physikInstrumente.piE625 as piE625 # tiger
...
class PiZStageFunctionality(stageZModule.ZStageFunctionalityBuffered):
    ...
    def goRelative(self, z_delta):
        ...
        # print('piezo module line 81 current pos is ')
        # print(self.z_position)
        # print('requested move is ')
        # print(z_delta)
    ...
    def position(self):
        ...
        return self.z_position    # note move directions are reversed here

    def zero(self):
        print('PI zero not implemented')
        # self.mustRun(task = self.z_stage.zZero)
        # self.zStagePosition.emit(0.0)
        #
    def zMoveTo(self, z_pos):
        return super().zMoveTo(z_pos)    # note move directions are reversed here
...
class PiController(stageModule.StageModule):
    def __init__(self, module_params = None, qt_settings = None, **kwds):
        ...
        self.controller = piE625.piE625() # connect to the controller
            ...
            for dev_name in devices.getAttrs():
                ...
                # Z stage
                    ...
                    z_stage_fn = PiZStageFunctionality(device_mutex = self.controller_mutex,
                                                       parameters = settings,
                                                       update_interval = 500,
                                                       velocity = settings.get("velocity", 1),
